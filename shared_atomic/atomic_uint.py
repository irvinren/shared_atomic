...
class atomic_uint:
    """
    Unsigned int provide atomic operations, the unsigned int should be no longer than 8 bytes
    """
    def __init__(self, value: int, mode: str = 'singleprocessing'):
        r"""
        constructor to initialize the atomic_uint,
    ...
    def get(self) -> int:
        """
        Get the value from atomic_uint,
        the int should be no longer than 8 bytes
        :return: the value
    ...
    def set(self, value: int):
        """
        set the value from atomic_uint,
        the int should be no longer than 8 bytes
